...
A Kubernetes MCP (Model Context Protocol) server that exposes **165+ tools**
covering all GA Kubernetes API resources. Works as a stdio server for
Claude Code or as an HTTP endpoint for in-cluster deployment.

## Features

- **165+ MCP tools** across 38 resource types covering every GA Kubernetes API group
